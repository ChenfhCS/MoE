...
from utils.exp_utils import create_exp_dir,load_bert_dataset_squad
from utils.data_parallel import BalancedDataParallel
from utils.prepare_model import Create_MoE_Model_Multi_Device
...
config_dict={}
config_dict['moe']=args.moe
config_dict['num_experts']=args.moe_num_expert // world_size
config_dict['world_size']=world_size
config_dict['group']=moe_comm_group
config_dict['top_k']=args.moe_top_k
config_dict['fuse_token']=args.fuse_token
model,tokenizer = Create_MoE_Model_Multi_Device(config_dict)
        ...
        if train_step % args.log_interval == 0:
            if local_rank == 0:
                ...
                log_str = '| step {:>8d} | {:>6d} batches | lr {:.3g} ' \
                    ...
                    train_step, batch + 1, optimizer.param_groups[0]['lr'],
